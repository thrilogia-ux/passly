    ...
    return (
      <button
        className={cn(
          ...
          {
            "bg-gradient-to-r from-[#ff5040] to-[#ff8a40] text-white hover:from-[#e04334] hover:to-[#ff7240]": variant === "default",
            "border-2 border-[#ff5040] bg-white text-[#ff5040] hover:bg-[#ff5040]/10": variant === "outline",
